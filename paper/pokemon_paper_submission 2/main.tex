...
Several practical lessons emerged during the ${\sim}$30{,}000-line development.
...
The 12 cross-module integration tests (\texttt{IntegrationTests.lean}) serve as both regression tests and documentation of the intended relationships between modules.
