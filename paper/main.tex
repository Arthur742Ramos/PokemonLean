...
\begin{table}[!t]
\centering
\caption{Sensitivity analysis: Nash weight 95\% confidence intervals (10{,}000 iterations). \emph{Inclusion} is the fraction of resampled equilibria in which the deck receives nonzero weight.}
\label{tab:bootstrap}
\begin{tabular}{l r r r}
\toprule
Deck & Point Est. & 95\% CI & Inclusion \\
\midrule
...
The Pok\'emon TCG lacks sideboarding, making the independence assumption substantially more defensible than in other TCGs.
