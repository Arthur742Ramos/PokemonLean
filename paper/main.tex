...
The support-concentrated profile in Table~\ref{tab:nash} is therefore interpreted as a computed candidate equilibrium, not an ad hoc narrative claim.
...
theorem metagame_shift_combo_increases_step1 :
    aggroMeta (Fin.mk 2 (by native_decide)) <
    replicatorStep 3 metaPayoff aggroMeta (1/10) (Fin.mk 2 (by native_decide)) := by
  optimize_proof
\end{lstlisting}
