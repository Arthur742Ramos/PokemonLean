...
Table~\ref{tab:symmetric} reports the symmetric Nash equilibrium weights; the equilibrium is machine-checked by \texttt{sym\_nash\_equilibrium\_verified} in \texttt{SymmetricNash.lean} (Listing~\ref{lst:symnash}).
