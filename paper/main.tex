...
At larger multi-agent scale, AlphaStar demonstrates superhuman play in StarCraft~II~\cite{vinyals2019alphastar}.
...
Related work also includes deckbuilding optimization and competition environments for TCG AI~\cite{bjorke2017deckbuilding,dockhorn2019hearthstone}.
...
Large collaborative libraries and landmark formal proofs further show the maturity of this ecosystem~\cite{mathlib2020,hales2017kepler}.
...
All Lean~4 source code and data are available at [repository URL redacted for review].
