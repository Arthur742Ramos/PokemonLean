...
We further report a fully verified Nash equilibrium (\texttt{real\_nash\_equilibrium\_verified}) where the row support is Grimssnarl Froslass (37.8\%), Raging Bolt Ogerpon (28.7\%), Mega Absol Box (12.9\%), Charizard Noctowl (11.3\%), Alakazam Dudunsparce (5.8\%), and Gardevoir (3.5\%); the column support replaces Alakazam Dudunsparce with Gholdengo Lunatone.
...
\begin{lstlisting}
-- File: PokemonLean/TypeEffectiveness.lean
theorem TRIANGLE :
    ∃ A B C : PType,
...
\begin{lstlisting}
-- File: PokemonLean/CardEffects.lean
...
\begin{lstlisting}
-- File: PokemonLean/DeckLegality.lean
...
\begin{lstlisting}
-- File: PokemonLean/DeckConsistency.lean
...
\begin{lstlisting}
-- File: PokemonLean/EnergyEconomy.lean
...
\begin{lstlisting}
-- File: PokemonLean/RealMetagame.lean
...
\begin{lstlisting}
-- File: PokemonLean/NashEquilibrium.lean
...
\begin{lstlisting}
-- File: PokemonLean/EvolutionaryDynamics.lean
...
\begin{lstlisting}
-- File: PokemonLean/TournamentStrategy.lean
...
\begin{lstlisting}
-- File: PokemonLean/Robustness.lean
