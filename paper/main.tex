...
We further report a fully verified Nash equilibrium (\texttt{real\_nash\_equilibrium\_verified}) with six-deck support: Regidrago (37.8\%), Gholdengo (28.6\%), Gardevoir (12.9\%), Lugia (11.3\%), Roaring Moon (5.8\%), and Raging Bolt (3.5\%).
...
We also prove replicator dynamics pressure against Dragapult and Ceruledge, and quantify best-of-three amplification effects such as 67.3\%\,$\to$\,74.9\% for Raging Bolt Ogerpon versus Mega Absol Box.
...
(iii) fully verified Nash-equilibrium computation (including all 14 pure-strategy best-response checks) and replicator dynamics statements, and
...
Third, we derive fully verified Nash-equilibrium and replicator-dynamics statements over the observed matrix, including complete best-response equilibrium certification.
...
Table~\ref{tab:nash} reports the verified six-deck support profile.
...
\begin{table}[!t]
\centering
\caption{Lean-verified real Nash equilibrium support (\texttt{real\_nash\_equilibrium\_verified}).}
\label{tab:nash}
\begin{tabular}{lc}
\toprule
\textbf{Deck} & \textbf{Nash Weight} \\
\midrule
Regidrago & 37.8\% \\
Gholdengo & 28.6\% \\
Gardevoir & 12.9\% \\
...
Table~\ref{tab:nash} shows a realistic six-deck support distribution, not an extreme two-strategy concentration.
...
The Lean-verified real Nash equilibrium has six-deck support and 0\% Dragapult weight, replicator dynamics predict Dragapult decline and Ceruledge extinction pressure, and best-of-three math amplifies already-large matchup edges (67.3\%\,$\to$\,74.9\%).
