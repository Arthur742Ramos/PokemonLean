...
We further report a fully verified Nash equilibrium (\texttt{real\_nash\_equilibrium\_verified}) where the row support is Grimmsnarl Froslass (37.8\%), Raging Bolt Ogerpon (28.7\%), Mega Absol Box (12.9\%), Charizard Noctowl (11.3\%), Alakazam Dudunsparce (5.8\%), and Gardevoir (3.5\%); the column support replaces Alakazam Dudunsparce with Gholdengo Lunatone.
Best-response conditions are machine-checked for all 14 pure strategies, the game value is approximately 47.97\%, and Dragapult receives 0\% equilibrium weight despite 15.5\% observed share.
We also prove replicator-dynamics pressure against Dragapult and Ceruledge on real-data representative subgames (4-deck and 5-deck slices), and quantify best-of-three amplification effects such as 67.3\%\,$\to$\,74.9\% for Raging Bolt Ogerpon versus Mega Absol Box.
...
The Lean-verified real Nash equilibrium has six-deck support per player and 0\% Dragapult weight; on representative real-data subgames, replicator dynamics predict Dragapult decline and Ceruledge extinction pressure; and best-of-three math amplifies already-large matchup edges (67.3\%\,$\to$\,74.9\%).
