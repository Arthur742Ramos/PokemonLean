...
The Lean-verified real Nash equilibrium has six-deck support per player and 0\% Dragapult weight (uniqueness not proven); full 14-deck replicator dynamics over the complete matchup matrix predict Dragapult decline, Grimmsnarl dominance, and Alakazam extinction pressure; and best-of-three math amplifies already-large matchup edges (67.3\%\,$\to$\,74.9\%).
